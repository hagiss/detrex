...
def do_test_ensemble(cfg, model1, model2):
    ...
    for data in tqdm(test_loader):
        ...
        # print("data", data)
        with torch.no_grad():
            multi_level_feats1, multi_level_masks, multi_level_position_embeddings1, query_embeds, attn_mask = model1.get_backbone_feature(data)
            multi_level_feats2, _, multi_level_position_embeddings2, _, _ = model2.get_backbone_feature(data)
